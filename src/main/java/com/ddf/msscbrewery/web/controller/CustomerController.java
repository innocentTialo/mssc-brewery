package com.ddf.msscbrewery.web.controller;

import com.ddf.msscbrewery.service.CustomerService;
...
public class CustomerController {
    ...
    public void handleDeletion(@PathVariable("customerId") UUID customerId) {
